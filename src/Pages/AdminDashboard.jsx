  ...
  return (
    <div className="flex min-h-screen font-inter">
      ...
      <aside className="hidden md:block w-64 bg-base-300 shadow-lg p-5">
        ...
        <h2 className="text-xl text-primary font-bold mb-6">Admin Dashboard</h2>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-40 flex">
          {/* Sidebar itself */}
          <div className="w-64 min-h-screen bg-base-300 shadow-lg flex flex-col p-3 animate-slide-in">
            <Link
              to="/"
