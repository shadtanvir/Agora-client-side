        ...
        {user && (
          <div className="relative" ref={profileRef}>
            <button
              ...
              className="p-0 border-2 rounded-full border-transparent hover:border-accent"
            ...
            {/* dropdown */}
            {profileOpen && (
              <div className="absolute -right-10 md:mt-50 w-48 md:w-55 bg-base-300  shadow-lg rounded-md z-50 text-sm">
    ...
    <div className="navbar sticky z-50 top-0 shadow-md px-4 py-2 bg-base-100 text-primary-content font-poppins h-20">
      <div className="navbar max-w-6xl mx-auto">
        ...
        <div className="flex-none navbar-center">
          <ul className="menu menu-horizontal md:items-center px-1 font-poppins text-lg hidden lg:flex">
            {navLinks}
          </ul>
        </div>
